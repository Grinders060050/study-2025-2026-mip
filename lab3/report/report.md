...
![Теоретические вероятности](image/1.png)

![Результат выполнения программы](image/2.png)
...
Сделаем файл исполняемым. После компиляции файла с проектом, запустим скрипт в созданном файле graph_plot (рис. [-@fig:003]), который создаст файл qm.png с результатами моделирования 
